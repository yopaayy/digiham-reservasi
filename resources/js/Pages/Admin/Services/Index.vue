...
// Fungsi delete with alert
const deleteService = (id) => {
    if (confirm("Apakah kamu yakin ingin menghapus layanan ini kawand?")) {
    ...
    <AuthenticatedLayout>
            ...
            >
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Kelola daftar jasa dan harga yang Anda tawarkan ke
                        pelanggan.
                    </p>
                </div>
                <Link
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div
                    class="bg-white overflow-hidden shadow-sm border border-gray-100 sm:rounded-2xl"
                >
                        ...
                        <table class="w-full text-left">
                            <thead class="bg-gray-50 border-b border-gray-100">
                                <tr>
                                    ...
                                    <th
                                        class="px-6 py-4 text-xs font-semibold uppercase text-gray-500 text-center"
                                    >
                                        Durasi
                                    </th>
                                    <th
                                    ...
                                    <th
                                        class="px-6 py-4 text-xs font-semibold uppercase text-gray-500 text-right"
                                    >
                                        Aksi
                                    </th>
                                </tr>
